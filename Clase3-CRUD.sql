...
/*
Ejercicio: Crear una tabla Clientes con los campos: ClienteID, Nombre, Apellido, Telefono, Email,Direccion(Pueden elegir los tipos de datos y tamaños). A continuación insertar 10 datos a elección.
